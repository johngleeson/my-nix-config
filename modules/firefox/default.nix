        ...
        extraPolicies = {
          ...
          ExtensionSettings = {
            ...
            "enhancerforyoutube@maximerf.addons.mozilla.org" = {
              install_url =
                "https://addons.mozilla.org/firefox/downloads/latest/enhancer_for_youtube/latest.xpi";
              installation_mode = "force_installed";
            };
            # Old reddit redirect
            "{9063c2e9-e07c-4c2c-9646-cfe7ca8d0498}" = {
              install_url =
                "https://addons.mozilla.org/firefox/downloads/latest/old_reddit_redirect/latest.xpi";
              installation_mode = "force_installed";
            };
            # Reddit Enhancement Suite
            "jid1-xUfzOsOFlzSOXg@jetpack" = {
              install_url =
                "https://addons.mozilla.org/firefox/downloads/latest/reddit_enhancement_suite/latest.xpi";
              installation_mode = "force_installed";
            };
            # Sponsorblock
            ...
            "magnolia_limited_permissions_d@12.34" = {
              install_url =
                "https://addons.mozilla.org/firefox/downloads/latest/bypass_paywalls_clean_d/latest.xpi";
              installation_mode = "force_installed";
            };
            # ClearURLs
            ...
            "{800215d6-eff0-4a62-9268-09857c048030}" = {
              install_url =
                "https://addons.mozilla.org/firefox/downloads/latest/continers_helper/latest.xpi";
              installation_mode = "force_installed";
            };
            # Dark Background and Light Text
            "jid1-QoFqdK4qzUfGWQ@jetpack" = {
              install_url =
                "https://addons.mozilla.org/firefox/downloads/latest/dark_background_light_text/latest.xpi";
              installation_mode = "force_installed";
            };
            # Don't Fuck With Paste
            "DontFuckWithPaste@raim.ist" = {
              install_url =
                "https://addons.mozilla.org/firefox/downloads/latest/don_t_fuck_with_paste/latest.xpi";
              installation_mode = "force_installed";
            };
            # Firefox Multi-Account Containers
            "@testpilot-containers" = {
              install_url =
                "https://addons.mozilla.org/firefox/downloads/latest/multi_account_containers/latest.xpi";
              installation_mode = "force_installed";
            };
            # OCR - Image Reader
            "{e4c6eef1-8b3b-4daa-8757-707702e7528d}" = {
              install_url =
                "https://addons.mozilla.org/firefox/downloads/latest/ocr_iamge_reader/latest.xpi";
              installation_mode = "force_installed";
            };
            # Sidebery
            ...
            "{a6c4a591-f1b2-4f03-b3ff-767e5bedf4e7}" = {
              install_url =
                "https://addons.mozilla.org/firefox/downloads/latest/user_agent_string_switcher/latest.xpi";
              installation_mode = "force_installed";
            };
            # Web Archives
